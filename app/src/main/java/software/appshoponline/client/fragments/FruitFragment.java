...
public class FruitFragment extends Fragment
    ...
    public void onStart() {
        ...
        if (fragment_actual == "HomeFragment")
            url = Dominio.URL_WebServie + Constantes.URL_Mostrar_Productos_x_Categoria + "/2";
        else if (fragment_actual == "LikesFragment")
            url = Dominio.URL_WebServie + Constantes.URL_Mostrar_Productos_Favoritos + "/"+usuario_id +"/2";
    ...
    private View.OnClickListener btnBuscarProducto = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (fragment_actual == "HomeFragment")
                url = Dominio.URL_WebServie + Constantes.URL_Buscar_Productos_x_Categoria + "/2/" + producto;
            else if (fragment_actual == "LikesFragment")
                url = Dominio.URL_WebServie + Constantes.URL_Buscar_Producto_Favorito_x_Categoria + "/"+usuario_id +"/2/" + producto;

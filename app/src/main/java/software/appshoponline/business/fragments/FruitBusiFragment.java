...
public class FruitBusiFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    private static String categoria_id = "2";
    ...
    public FruitBusiFragment() {
        // Required empty public constructor
    }

    public static FruitBusiFragment newInstance(String param1, String param2) {
        FruitBusiFragment fragment = new FruitBusiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_fruit_busi, container, false);
        recycler = root.findViewById(R.id.recyclerCardFrutasBusi);
        recycler.setLayoutManager(new LinearLayoutManager(root.getContext(), LinearLayoutManager.VERTICAL, false));

        txtBuscar = root.findViewById(R.id.frgfruitsbusi_txtBuscar);
        btnBuscar = root.findViewById(R.id.frgfruitsbusi_btnBuscar);
        btnBuscar.setOnClickListener(btnBuscarProducto);
        btnAgregar = root.findViewById(R.id.frgfruitsbusi_btnAgregar);

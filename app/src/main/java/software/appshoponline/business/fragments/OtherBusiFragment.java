...
public class OtherBusiFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    private static String categoria_id = "4";
    ...
    public OtherBusiFragment() {
        // Required empty public constructor
    }

    public static OtherBusiFragment newInstance(String param1, String param2) {
        OtherBusiFragment fragment = new OtherBusiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_other_busi, container, false);
        recycler = root.findViewById(R.id.recyclerCardOtrosBusi);
        recycler.setLayoutManager(new LinearLayoutManager(root.getContext(), LinearLayoutManager.VERTICAL, false));

        txtBuscar = root.findViewById(R.id.frgotherbusi_txtBuscar);
        btnBuscar = root.findViewById(R.id.frgotherbusi_btnBuscar);
        btnBuscar.setOnClickListener(btnBuscarProducto);
        btnAgregar = root.findViewById(R.id.frgotherbusi_btnAgregar);
